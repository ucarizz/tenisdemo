...
namespace TenisApi.Domain.Entities
{
    public class User
    {
        ...
        public bool IsKvkkAccepted { get; private set; }
        public DateTime? KvkkAcceptedAt { get; private set; }

        #pragma warning disable CS8618 // EF Core için gerekli boş kurucu metot
        private User() { }
        #pragma warning restore CS8618

        public User(string email, string passwordHash, string fullName, bool isKvkkAccepted = true)
        {
            ...
            if (!isKvkkAccepted)
                throw new ArgumentException("Kayıt olabilmek için KVKK Aydınlatma Metni'ni kabul etmelisiniz.");
            ...
            KvkkAcceptedAt = isKvkkAccepted ? DateTime.UtcNow : null;
        }
