...
//  tenisdemo Watch App
//
//  Created for Modern Sports Analytics & Linear / Vercel Minimal Aesthetic on Apple Watch
//
...
extension Color {
    ...
    static let badgeBlue = Color(red: 56/255, green: 189/255, blue: 248/255)   // NTRP seviyesi
    static let badgeAmber = Color(red: 251/255, green: 191/255, blue: 36/255)  // Bekleyen
    static let badgeRed = Color(red: 248/255, green: 113/255, blue: 113/255)   // Hata
