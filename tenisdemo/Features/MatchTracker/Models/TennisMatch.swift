...
class TennisMatchViewModel: ObservableObject {
    ...
    private func syncMatchResult() {
        ...
        // Set skorlarını birleştiriyoruz (Örn: 6-4, 4-6)
        let scoreString = state.setScores.map { "\($0.p1Games)-\($0.p2Games)" }.joined(separator: ", ")
